...
private:
    ...
    constexpr static const float MAX_STEPS_PER_SECOND = (const float) (STEPS_PER_ROTATION / 10.0);
    constexpr static const float DEGREES_ACC_MAX = 1.8;
    float acc_max;
    ...
    volatile uint32_t position_current = 0;
    volatile uint32_t position_destination = 0;
